...
public class OutQueryDetail extends JFrame {// 销售单内部窗体
	...
	public OutQueryDetail() {// 销售单内部窗体的构造方法
...
DefaultTableCellRenderer r = new DefaultTableCellRenderer();   
	...
	private void updateTable(List list, final DefaultTableModel dftm) {
		...
		while (iterator.hasNext()) {
			...
			ypInfo = Dao.getCKInfo(item,Global.xs_number);
...
private List searchInfo(List list) {
	String sql = "select * from tb_out_detail where ";
