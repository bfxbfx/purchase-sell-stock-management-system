...
public class StockInDetail extends JFrame {// 销售单内部窗体
	...
	public StockInDetail() {// 销售单内部窗体的构造方法
...
//		setClosable(true);// 可以关闭销售单内部窗体
		...
		setupComponet(new JLabel("采购单号："), 0,0,1,0,false);
		...
		// “出库”按钮
		final JButton tjButton = new JButton("关联生成入库单");
		
		tjButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JFrame inFrm = new StockInBill(); 
