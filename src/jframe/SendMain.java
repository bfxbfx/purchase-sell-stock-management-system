...
public class SendMain extends JInternalFrame{// 销售查询内部窗体
...
//				date.setDate(1);
		...
		setTitle("已出库销售单查询");// 设置销售查询内部窗体的标题
		...
		showAllButton.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				content.setText("");
				List list=Dao.findForList("select * from tb_sale where state = '已出库，待发货'");
		...
		showAllButton.setText("显示全部已出库销售单");
		// 滚动面板
