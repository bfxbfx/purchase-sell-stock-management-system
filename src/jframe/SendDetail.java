...
public class SendDetail extends JFrame {// 销售单内部窗体
	...
	public SendDetail() {// 销售单内部窗体的构造方法
...
//		setClosable(true);// 可以关闭销售单内部窗体
		...
		setTitle("已出库销售单据详情");// 设置销售单内部窗体的标题
		...
		// “出库”按钮
		final JButton tjButton = new JButton("关联生成发货单");
		
		tjButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JFrame inFrm = new SendBill(); 
