...
public class StockOutDetail extends JFrame {// 销售单内部窗体
	...
	public StockOutDetail() {// 销售单内部窗体的构造方法
...
//		setClosable(true);// 可以关闭销售单内部窗体
		...
		// “出库”按钮
		final JButton tjButton = new JButton("关联生成出库单");
		
		tjButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JFrame inFrm = new StockOutBill(); 
