...
public class BuyBill extends JInternalFrame {// 销售单内部窗体
	...
	public BuyBill() {// 销售单内部窗体的构造方法
		...
		getContentPane().setBackground(new Color(236,237,220));
		...
		sellButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (table.getRowCount() <= 0) {
					JOptionPane.showMessageDialog(BuyBill.this, "填加采购药品");
					return;
				}
				...
				if (rs) {
					JOptionPane.showMessageDialog(BuyBill.this, "采购发送完成");
